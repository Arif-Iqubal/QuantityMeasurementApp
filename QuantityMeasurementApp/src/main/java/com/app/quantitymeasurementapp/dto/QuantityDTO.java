...
public class QuantityDTO {
	...
	public QuantityDTO(@NotNull(message = "Value cannot be empty") double value,
			@NotNull(message = "Unit cannot be null") String unit,
			@NotNull(message = "Measurement type cannot be null") @Pattern(regexp = "(?i)LengthUnit|VolumeUnit|WeightUnit|TemperatureUnit", message = "Measurement type must be one of: LengthUnit, VolumeUnit, WeightUnit, TemperatureUnit") String measurementType) {
		super();
		this.value = value;
		this.unit = unit;
