...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorResponse> handleCategoryMismatchException(CategoryMismatchException e,
	...
	public ResponseEntity<ErrorResponse> handleInvalidUnitException(InvalidUnitException e,
			HttpServletRequest request) {
		ErrorResponse errro = new ErrorResponse();
		errro.setDateTime(LocalDateTime.now());
	...
	public ResponseEntity<ErrorResponse> handleInvalidUnitMeasurementException(InvalidUnitMeasurementException e,
			HttpServletRequest request) {
		ErrorResponse errro = new ErrorResponse();
		errro.setDateTime(LocalDateTime.now());
		errro.setStatus(HttpStatus.NOT_ACCEPTABLE.value());
	...
	public ResponseEntity<ErrorResponse> handleQuantityMeasurementException(QuantityMeasurementException e,
			HttpServletRequest request) {
		ErrorResponse errro = new ErrorResponse();
		errro.setDateTime(LocalDateTime.now());
		errro.setStatus(HttpStatus.BAD_REQUEST.value());
